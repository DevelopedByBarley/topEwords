...
* @see app/Http/Controllers/UserCustomWordController.php:21
* @route '/custom-words'
*/
...
* @see app/Http/Controllers/UserCustomWordController.php:41
...
* @see app/Http/Controllers/UserCustomWordController.php:69
...
* @see app/Http/Controllers/UserCustomWordController.php:93
...
* @see app/Http/Controllers/UserCustomWordController.php:104
* @route '/custom-words/{customWord}'
*/
