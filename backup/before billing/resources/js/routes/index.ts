...
* @route '/handbook'
*/
export const handbook = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: handbook.url(options),
    method: 'get',
})
...
* @route '/handbook'
*/
handbook.url = (options?: RouteQueryOptions) => {
    return handbook.definition.url + queryParams(options)
}
...
* @route '/handbook'
*/
handbook.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: handbook.url(options),
    method: 'get',
})
...
* @route '/handbook'
*/
handbook.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: handbook.url(options),
    method: 'head',
})
...
* @route '/handbook'
*/
const handbookForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: handbook.url(options),
    method: 'get',
})
...
* @route '/handbook'
*/
handbookForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: handbook.url(options),
    method: 'get',
})
...
* @route '/handbook'
*/
handbookForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: handbook.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
