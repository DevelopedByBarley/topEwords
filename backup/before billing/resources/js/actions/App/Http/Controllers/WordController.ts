...
* @see app/Http/Controllers/WordController.php:25
* @route '/words'
*/
...
* @see app/Http/Controllers/WordController.php:484
* @route '/words/{word}'
*/
...
* @see app/Http/Controllers/WordController.php:512
...
* @see app/Http/Controllers/WordController.php:554
...
const WordController = { index, search, update, status, importance, practice, quiz }
