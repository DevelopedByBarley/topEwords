        ...
        searchTimeout.current = setTimeout(async () => {
            ...
            try {
                const res = await fetch(
                    `/words/search?q=${encodeURIComponent(q)}`,
                    {
...
setShowDropdown(false);
                                            ...
                                            className="w-full rounded-md border bg-background py-1.5 pr-3 pl-8 text-base outline-none focus:ring-2 focus:ring-ring md:text-sm"
                                    ...
                                    <button
                                        ...
                                        className="rounded-md border bg-primary px-2.5 text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-40"
                                        title="Hozzáadás"
                                    >
                            ...
                            {targetWords.length === 0 ? (
                                <p className="py-4 text-center text-xs text-muted-foreground">
                                    Adj hozzá szavakat a szólistából vagy
                                    gépelje be kézzel.
                                </p>
                            ) : (
