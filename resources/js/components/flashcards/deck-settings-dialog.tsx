...
export default function DeckSettingsDialog({
    ...
    return (
        <>
            ...
            >
                <DialogContent className="flex max-h-[92dvh] w-[calc(100vw-2rem)] flex-col sm:max-w-2xl">
                    <DialogHeader className="pr-8">
                        ...
                        <DialogDescription>
                            Ezek a beállítások csak erre a paklira érvényesek.
                            Mentés nélkül a pakli a globális beállításokat
                            követi.
                        </DialogDescription>
                    </DialogHeader>
                                    ...
                                    <div key={presetKey} className="space-y-6">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                Amikor először látsz egy új
                                                kártyát, ennyi időnként kérdez
                                                rá újra, mielőtt „megtanultnak"
                                                minősül. Pl.{' '}
                                                <span className="font-medium">
                                                    1 perc → 10 perc → 1 nap
                                                </span>
                                                : háromszor kell helyesen
                                                megválaszolni növekvő
                                                időközönként. Több lépés =
                                                alaposabb rögzítés.
                                            </p>
                                            <div className="space-y-2">
                                                {steps.map((step, i) => (
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid gap-4 sm:grid-cols-2">
                                                <SettingField
                                                    ...
                                                    defaultValue={
                                                        s.graduating_interval
                                                    }
                                                    min={1}
                                                    max={365}
                                                    error={
                                                        errors.graduating_interval
                                                    }
                                                    suffix="nap"
                                                />
                                                <SettingField
                                                ...
                                                <SettingField
                                                    ...
                                                    defaultValue={
                                                        s.lapse_new_interval
                                                    }
                                                    min={0}
                                                    max={100}
                                                    error={
                                                        errors.lapse_new_interval
                                                    }
                                                    suffix="%"
                                                />
                                                <SettingField
                                            ...
                                            <label className="flex cursor-pointer items-start gap-3">
                                                ...
                                                <div className="grid gap-0.5">
                                                    ...
                                                    <span className="text-xs text-muted-foreground">
                                                        ...
                                                        mutatja a kártyákat —
                                                        kétoldalú kártyáknál az
                                                        előlap és hátlap nem
                                                        kerül egymás mellé.
                                                    </span>
                                                </div>
                                            </label>
            ...
            <ConfirmDialog
                ...
                title="Egyéni beállítások törlése"
                confirmLabel="Igen, törlöm"
                description="A pakli innentől a globális beállításaidat követi. A kártyák és a tanulási haladás nem változik."
                onConfirm={() =>
