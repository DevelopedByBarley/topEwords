                    ...
                    <div className="max-w-3xl min-w-0 flex-1 space-y-14">
                        ...
                        >
                            ...
                            <Sub title="Telepítés (béta — fejlesztői mód)">
                                ...
                                <Steps
                                    items={[
                                        'Töltsd le a fenti .zip fájlt, majd csomagold ki egy mappába (jegyezd meg, hova).',
                                        <>
                                            Nyisd meg a böngészőben a
                                            bővítmények oldalát:{' '}
                                            <ChromeExtensionsLink /> — másold be
                                            a címsorba és nyomj Entert.
                                        </>,
                                        <>
                                            Kapcsold be jobbra fent a{' '}
                                            <strong>Fejlesztői mód</strong>{' '}
                                            (Developer mode) kapcsolót.
                                        </>,
                                        <>
                                            Kattints a{' '}
                                            <strong>
                                                Kicsomagolt elem betöltése
                                            </strong>{' '}
                                            (Load unpacked) gombra, és válaszd
                                            ki az imént kicsomagolt mappát.
                                        </>,
                                        <>
                                            Tűzd ki: kattints a puzzle ikonra a
                                            Chrome eszköztáron, majd a{' '}
